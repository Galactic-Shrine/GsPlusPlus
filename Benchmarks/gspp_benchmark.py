#!/usr/bin/env python3
"""Banc de mesure reproductible pour Gs++ 0.27.0-alpha.6.
...
SCHEMA_VERSION = 1
EXPECTED_COMPILER_VERSION = "0.27.0-alpha.6"
EXPECTED_COMPILER_BANNER = "Gs++ Compiler 0.27.0-alpha.6"
EXPECTED_LOADER_BANNER = "Chargeur GsE 0.27.0-alpha.6"
...
def parse_arguments(argv: Sequence[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Banc de mesure Gs++ 0.27.0-alpha.6 fondé sur les corpus validés.",
    )
    parser.add_argument(
        "--source-root",
        type=Path,
    ...
    parser.add_argument("--compiler", type=Path, help="Chemin de gsppc 0.27.0-alpha.6.")
    parser.add_argument("--loader", type=Path, help="Chemin de gsechargeur 0.27.0-alpha.6.")
    parser.add_argument(
        "--output-root",
        type=Path,
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Autoriser un compilateur ne déclarant pas 0.27.0-alpha.6 (signalé dans les métadonnées).",
    )
    parser.add_argument(
        "--list-scenarios",
        action="store_true",
